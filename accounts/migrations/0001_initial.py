    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=16, verbose_name='phone number')),
                ('identity', models.IntegerField(error_messages={'unique': 'A school with that identity already exists.'}, help_text='Required. Has to be unique', unique=True, validators=[django.core.validators.RegexValidator(code='invalid_identity', message='must be a 8 digits text', regex='^\\d{8}$')], verbose_name='Identity')),
            ],
        ),
        migrations.CreateModel(
            name='Parent',
